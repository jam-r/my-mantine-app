  ...
  return (
    <div className="App">
      <Grid justify="space-around" > 
        <Grid.Col style={{ maxWidth: 350 }} sm={4} xs={4}  mt="md" mb="md">
          <Card className="cards" shadow="sm" padding="lg" radius="md" withBorder style={{ minHeight: 475 }}>
            <Card.Section>
              <Image
            ...
            <Text  size="sm"  style={{ minHeight: 150 }}>
            ...
            <Button onClick={()=>navigate("/my-mantine-app/detail")} variant="light"  fullWidth mt="md" radius="md">
              Cotizar
            </Button>
          </Card>
        </Grid.Col>
        ...
        <Grid.Col style={{ maxWidth: 350 }} sm={4} xs={4} mt="md" mb="md">
          <Card className="cards" shadow="sm" padding="lg" radius="md" withBorder >
            ...
            <Text size="sm"  color="sea-pink.8"  style={{ minHeight: 150 }}>
